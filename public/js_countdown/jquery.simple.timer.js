...
(function($){
  ...
  Timer.prototype.start = function(options) {
    ...
    this.targetElement.each(function(_index, timerBox) {
      ...
      timerBoxElement.on('two_minutes_trigger', function() {
        timerBoxElement.onTwoMinTrigger(timerBoxElement);
      });
  ...
  Timer.prototype.startCountdown = function(element, options) {
    ...
    var defaultTwoMinTrigger  = function(){
      //Do nothing by default
    }.bind(this);

    element.onComplete = options.onComplete || defaultComplete;
    element.onTwoMinTrigger = options.onTwoMinTrigger || defaultTwoMinTrigger;
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    if(finalValues[2] === "00" && finalValues[1] === "02" && finalValues[0] === "00"){
      element.trigger('two_minutes_trigger');
    }
