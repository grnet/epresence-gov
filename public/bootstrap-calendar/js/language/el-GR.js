...
window.calendar_languages['el-GR'] = {
	...
	error_loadurl:    'Ημερολόγιο: Η διεύθυνση λήψης των τηλεδιασκέψεων δεν έχει καθοριστεί',
	...
	time:        'Χρόνος',
	events:      'Τηλεδιασκέψεις',
	before_time: 'Ώρα πριν από το τέλος της γραμμής χρόνου',
	after_time:  'Τερματισμός μετά από την γραμμή χρόνου',
