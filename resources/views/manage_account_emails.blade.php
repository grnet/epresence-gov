                ...
                <div class="well well-sm" style="overflow:auto;">
                    ...
                    <div class="alert alert-warning help-block col-sm-12" role="alert">
                        ...
                        @if($slots_remaining>0)
                            {!! Form::open(array('url' => ['/account/emails/add_new'], 'method' => 'POST', 'class' => 'form-horizontal')) !!}
                            <div class="form-group">
                                <div class="col-sm-8">
...
<script>
    ...
    function resendActivationLink(id){
        ...
        $.post("/account/emails/resend_extra_email_confirmation", {
            _token: "{!!csrf_token()!!}",
            id: parseInt(id)
        })
            .done(function (data) {
    ...
    function deleteExtraMail(id) {
        ...
        if (r === true) {
            $.post("/account/emails/deleteExtraEmail", {
                _token: "{!!csrf_token()!!}",
                id: parseInt(id)
            })
                .done(function (data) {
    ...
    function makePrimary(id) {
        ...
        if (r === true) {
            $.post("/account/emails/makePrimary", {
                _token: "{!!csrf_token()!!}",
                id: parseInt(id)
            })
                .done(function (data) {
