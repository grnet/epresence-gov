...
// ΛΕΠΤΟΜΕΡΕΙΕΣ ΤΗΛΕΔΙΑΣΚΕΨΗΣ
            ...
            $('#FieldStartTime').timepicki({
                ...
                start_time: ["<?php echo $default_values['start_hour']; ?>", "<?php echo $default_values['start_minute']; ?>"]
            });
            ...
            $('#FieldEndTime').timepicki({
                ...
                increase_direction: 'up',
                disable_keyboard_mobile: true,
                start_time: ["<?php echo $default_values['end_hour']; ?>", "<?php echo $default_values['end_minute']; ?>"]
            });
        ...
        <div class="container">
            ...
            <div class="box" style="padding:30px 30px  20px 30px">
                <div class="row" style="margin:0px;">
                    <!-- <div class="alert alert-info" role="alert" id="TeleDetailsAlert" style="margin: 0px 15px 10px 15px" >
                       Η αποθήκευση πραγματοποιηθηκε με επιτυχία
                   </div> -->
                    @if ($errors->any())
                    ...
                    @endif
                    {!! Form::open(array('url' => 'conferences', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'OrgForm', 'role' => 'form')) !!}
                    ...
                    [
                     ...
                     'invisible' => 0,
                     'submitBtn' => trans('conferences.saveContinue'),
                     'copyBtn' => '',
                     'apella_id'=>''
                    ])
                    {!! Form::close() !!}
