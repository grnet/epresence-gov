				...
				<div class="row">
					<div class="col-md-12">
						<div class="error-template">
							...
							{!! $reload_button !!}<a href="mailto:{{env('SUPPORT_MAIL')}}" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span> {{trans('conferences.supportContact')}} </a>
							</div>
						</div>
					</div>
				</div>
