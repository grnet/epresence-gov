...
<div class="container-fluid">
    <div class="row pull-right">
        <a href="/"><span class="glyphicon glyphicon glyphicon-home" style="margin:20px; font-size:25px"
                          data-toggle="tooltip" data-placement="left" title="{{trans('auth.homePage')}}"></span></a>
    </div>
    <div class="row">
        <div id="loginbox" class=" box col-xs-12" style="max-width:350px; padding:20px">
            <div class="row">
                <div class="col-sm-12" style="margin-bottom:20px;">
                    <img src="/images/epresence-logo.png" class="img-responsive" alt="Logo">
                </div>
                <div class="col-sm-12">
                    <h3 class=" pull-right" style="margin-top:0; color:#666"> {{trans('auth.entryPoint')}}</h3>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="checkbox" style="padding-left:0">
                            <input id="remember" data-toggle="checkbox-x" data-size="xs" data-three-state="false"
                                   name="remember" type="checkbox"/>
                            <label class="cbx-label" for="remember"><small>{{trans('auth.rememberMe')}}</small></label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <button type="submit" class="btn btn-success pull-right">{{trans('auth.entryPoint')}} <span
