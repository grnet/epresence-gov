					...
					<div class="col-md-12">
						<div class="error-template">
							...
							<div class="error-details">
								Η λειτουργία αυτή είναι υπό κατασκευή!
							</div>
							<div class="error-actions">
								<a href="mailto:{{env('SUPPORT_MAIL')}}" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span> Ομάδα Υποστήριξης </a>
							</div>
						</div>
					</div>
				</div>
