				...
				<div class="row">
					<div class="col-md-12">
						<div class="error-template">
							<p class="lead">{{trans('errors.pageNotFound')}}</p>
							<div class="error-actions">
								<a href="/" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
								{{trans('errors.homePage')}} </a><a href="mailto:support@epresence.grnet.gr" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span> {{trans('errors.supportContact')}} </a>
							</div>
						</div>
					</div>
				</div>
