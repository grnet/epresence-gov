        ...
        <div class="container">
            <div id="navbar" class="navbar navbar-default">
				...
				@if (Auth::check())
                    ...
                    <li @yield('conference-active')><a href="/conferences?limit=50&sort_start=asc">{{trans('site.conferences')}}</a></li>
						@else
							<li @yield('conference-active')><a href="/conferences">{{trans('site.conferences')}}</a></li>
						@endif
					@can('view_users_menu')
                    <li @yield('users-active')><a href="/users">{{trans('site.users')}}</a></li>
					@endcan
					@can('view_institutions')
                    <li @yield('institutions-active')><a href="/institutions">{{trans('site.institutions')}}</a></li>
					@endcan
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@if(!empty(Auth::user()->thumbnail))
												<img src="/images/user_images/{{ Auth::user()->thumbnail }}" class="img-responsive" alt="Responsive image">
											@else
										...
										<div class="col-lg-8">
											...
											<p class="text-left">
												<a href="/account" class="btn btn-primary btn-block btn-sm">{{trans('site.myAccount')}}</a>
											</p>
										</div>
									</div>
								</div>
							...
							<li>
								<div class="navbar-login navbar-login-session">
									<div class="row">
										<div class="col-lg-12">
											<p>
												<a href="/auth/logout" class="btn btn-danger btn-block">{{trans('site.logout')}}</a>
											</p>
										</div>
									</div>
								</div>
